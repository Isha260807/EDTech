  ...
  useEffect(() => {
    const fetchCategories = async () => {
      ...
      try {
        ...
        // 🔥 CRITICAL FIX: NEVER trust API blindly
              ...
              <li key={index}>
                {link.title === "Catalog" ? (
                  ...
                  >
                    ...
                    {/* Dropdown */}
                    <div className="invisible absolute left-1/2 top-1/2 z-[1000] w-[200px] -translate-x-1/2 translate-y-[3em] rounded-lg bg-richblack-5 p-4 text-richblack-900 opacity-0 transition-all duration-150 group-hover:visible group-hover:translate-y-[1.65em] group-hover:opacity-100 lg:w-[300px]">
